...
/**
 * Create MSSystemCenterVMM Configuration.
 */
    ...
    extends InternalFormBase
{
    ...
    public CreateConfiguration()
    {
        ...
        super("New MSSystemCenterVMM Configuration",
            "MSSystemCenterVMM Configurations");
    ...
    @Override protected void load()
    {
        ...
        loader.setCustomEditorPath("/plugins/EC-MSSystemCenterVMM"
                + "/project/ui_forms/HyperVCreateConfigForm");
        loader.load();
        clearStatus();
    }
