...
my $PLUGIN_NAME = 'EC-MSSystemCenterVMM';
...
my $xpath = $ec->getProperty("/myProject/hyperv_cfgs/$opts->{config}");
...
my $cfg = new ElectricCommander::PropDB($ec,"/myProject/hyperv_cfgs");
